...
public class Database {
    ...
    public static void addTicket(CommandInput command) {
        // im too lazy right now but before you do this func check how the inputs should look like, maybe you should link the tickets to an actual person if its mandatory but afaik for bugs its not so you can either create a anon user and add all anoms to him or maybe not link at all i cba this is too boring
    }
